...
- [ ] **VirtualBox Manager** — Main window showing all three VMs listed (DC-SERVER01, WS-CLIENT01, UBUNTU-SVR01) — [View sample output](../../docs/screenshots/lab00-vbox-manager.txt)
...
- [ ] **DC-SERVER01 static IP** — `ipconfig /all` output showing 192.168.1.10 on the internal adapter — [View sample output](../../docs/screenshots/lab00-dc-server01-ipconfig.txt)
- [ ] **WS-CLIENT01 static IP** — `ipconfig /all` output showing 192.168.1.100 on the internal adapter — [View sample output](../../docs/screenshots/lab00-ws-client01-ipconfig.txt)
- [ ] **UBUNTU-SVR01 static IP** — `ip addr show enp0s8` output showing 192.168.1.200/24 — [View sample output](../../docs/screenshots/lab00-ubuntu-ip-addr.txt)
- [ ] **Ping test — Server to Client** — `ping 192.168.1.100` from DC-SERVER01 showing successful replies — [View sample output](../../docs/screenshots/lab00-ping-server-to-client.txt)
- [ ] **Ping test — Client to Server** — `ping 192.168.1.10` from WS-CLIENT01 showing successful replies — [View sample output](../../docs/screenshots/lab00-ping-client-to-server.txt)
- [ ] **Ping test — Ubuntu to Server** — `ping -c 4 192.168.1.10` from UBUNTU-SVR01 showing successful replies — [View sample output](../../docs/screenshots/lab00-ping-ubuntu-to-server.txt)
