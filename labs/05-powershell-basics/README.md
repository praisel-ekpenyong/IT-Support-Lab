...
| 4 | Disk space report — CSV file | Screenshot of `Import-Csv .\Output\DiskReport.csv \| Format-Table` |
| 5 | Event log export — console | Screenshot showing the export count or "no events" message |
| 6 | Event log export — CSV contents | Screenshot of `Import-Csv .\Output\EventErrors.csv \| Select -First 5 \| Format-Table` |
